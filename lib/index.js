...
module.exports = (reporter, definition) => {
  ...
  reporter.beforeRenderListeners.insert({ after: 'data' }, 'xlsxTemplates', async (req) => {
    ...
    reporter.extendRequestData(req, {
      $xlsxTemplate: template,
      $xlsxModuleDirname: path.join(__dirname, '../'),
      $tempAutoCleanupDirectory: reporter.options.tempAutoCleanupDirectory,
      $addBufferSize: definition.options.addBufferSize || 50000000,
      $escapeAmp: definition.options.escapeAmp,
      $numberOfParsedAddIterations: definition.options.numberOfParsedAddIterations == null ? 50 : definition.options.numberOfParsedAddIterations
    })
